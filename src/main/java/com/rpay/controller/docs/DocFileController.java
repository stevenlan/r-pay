...
import com.rpay.model.Dtree;
import com.rpay.model.FilePojo;
import com.rpay.service.FileService;
...
public class DocFileController extends BaseController {
     ...
     * @return
     */
    @ApiOperation(value = "文件上传接口，目前允许上传到嗯文件只有png,jpg,压缩文件和PDF，大小在20M以内，dirIds不需要传值")
    @PostMapping({"", "/upload"})
     ...
     * @param response
     */
    @ApiOperation(value = "文件下载接口，url下载连接由后台生成")
